    ...
    [
        ...
        },
        {
            e: div({
                ...
                div({id: "company-container", class: ["studio-container", "user-interface", "end-display-flex", "end-fy-center", "end-fx-center"], text: `<img src="./public/images/Microsoft_logo_(2012).svg.webp" width="70%">`, attr: {org: "element", name: "element", element: "div", type: "company-container", untx: "UTF-8 unicode ascii"}, data: {org: "element", skeletion: "active"}, parent: js.$("#companies-container"), style: {height: "100px", marginTop: "40px", "--i": 1}}),
                div({id: "company-container", class: ["studio-container", "user-interface", "end-display-flex", "end-fy-center", "end-fx-center"], text: `<img src="./public/images/Airtable_Logo.svg.png" width="70%">`, attr: {org: "element", name: "element", element: "div", type: "company-container", untx: "UTF-8 unicode ascii"}, data: {org: "element", skeletion: "active"}, parent: js.$("#companies-container"), style: {height: "100px", marginTop: "40px", "--i": 2}}),
                div({id: "company-container", class: ["studio-container", "user-interface", "end-display-flex", "end-fy-center", "end-fx-center"], text: `<img src="./public/images/Slack_Technologies_Logo.svg.png" width="70%">`, attr: {org: "element", name: "element", element: "div", type: "company-container", untx: "UTF-8 unicode ascii"}, data: {org: "element", skeletion: "active"}, parent: js.$("#companies-container"), style: {height: "100px", marginTop: "40px", "--i": 3}}),
                div({id: "company-container", class: ["studio-container", "user-interface", "end-display-flex", "end-fy-center", "end-fx-center"], text: `<img src="./public/images/Square,_Inc._logo.svg" width="70%">`, attr: {org: "element", name: "element", element: "div", type: "company-container", untx: "UTF-8 unicode ascii"}, data: {org: "element", skeletion: "active"}, parent: js.$("#companies-container"), style: {height: "100px", marginTop: "40px", "--i": 4}}),
                div({id: "company-container", class: ["studio-container", "user-interface", "end-display-flex", "end-fy-center", "end-fx-center"], text: `<img src="./public/images/Asana_logo.svg.png" width="70%">`, attr: {org: "element", name: "element", element: "div", type: "company-container", untx: "UTF-8 unicode ascii"}, data: {org: "element", skeletion: "active"}, parent: js.$("#companies-container"), style: {height: "100px", marginTop: "40px", "--i": 5}}),
                div({id: "company-container", class: ["studio-container", "user-interface", "end-display-flex", "end-fy-center", "end-fx-center"], text: `<img src="./public/images/Amazon_logo.svg.png" width="70%">`, attr: {org: "element", name: "element", element: "div", type: "company-container", untx: "UTF-8 unicode ascii"}, data: {org: "element", skeletion: "active"}, parent: js.$("#companies-container"), style: {height: "100px", marginTop: "40px", "--i": 6}}),
                div({id: "company-container", class: ["studio-container", "user-interface", "end-display-flex", "end-fy-center", "end-fx-center"], text: `<img src="./public/images/linear-logo-freelogovectors.net_-1536x428.png" width="70%">`, attr: {org: "element", name: "element", element: "div", type: "company-container", untx: "UTF-8 unicode ascii"}, data: {org: "element", skeletion: "active"}, parent: js.$("#companies-container"), style: {height: "100px", marginTop: "40px", "--i": 7}}),
                div({id: "company-container", class: ["studio-container", "user-interface", "end-display-flex", "end-fy-center", "end-fx-center"], text: `<img src="./public/images/Spotify_logo_with_text.svg" width="70%">`, attr: {org: "element", name: "element", element: "div", type: "company-container", untx: "UTF-8 unicode ascii"}, data: {org: "element", skeletion: "active"}, parent: js.$("#companies-container"), style: {height: "100px", marginTop: "40px", "--i": 8}})
                ]))
        },
        {
            e: div({
                ...
                div({id: "company-container",class: ["company-container", "user-interface", "end-display-block"],text: `<p style="text-align:left">The Central Processing Unit (CPU) is the primary component of a computer that performs most of the processing inside the system, often referred to as the "brain" of the machine. It executes instructions from computer programs by performing basic arithmetic, logic, control, and input/output operations specified by the code. Comprised of a control unit that directs operations and an arithmetic logic unit (ALU) that handles mathematical calculations, the CPU fetches instructions from memory, decodes them, and then executes them in a continuous cycle. Its speed, measured in gigahertz (GHz), largely determines how quickly a computer can respond and run applications, making it a critical factor in overall system performance.</p>`,attr: {org: "element",name: "element",element: "div",type: "company-container",untx: "UTF-8 unicode ascii"},data: {org: "element",skeletion: "active"},parent: js.$("#companies-container"), style: {height: "auto", marginTop: "40px", "--i": 2}}),  
                 div({id: "company-container",class: ["company-container", "user-interface", "end-display-block", "end-position-relative"],text: "<img src='./public/images/amd-cpu.png' class='end-position-absolute' style='width: 340px;top: 50%;left: 50%; transform: translate(-50%, -50%);filter: blur(100px) contrast(2)'><img src='./public/images/amd-cpu.png' class='end-position-absolute' style='width: 340px;top: 50%;left: 50%; transform: translate(-50%, -50%);filter: contrast(1.3)'>",attr: {org: "element",name: "element",element: "div",type: "company-container",untx: "UTF-8 unicode ascii"},data: {org: "element",skeletion: "active"},parent: js.$("#companies-container"), style: {height: "auto", marginTop: "40px", "--i": 2}})
                ]))
        },
        {
            e: div({
                ...
                div({id: "company-container",class: ["company-container", "user-interface", "end-display-block", "end-position-relative"],text: "<img src='./public/images/intel-cpu.png' class='end-position-absolute' style='width: 340px;top: 50%;left: 50%; transform: translate(-50%, -50%);filter: blur(100px) contrast(2)'><img src='./public/images/intel-cpu.png' class='end-position-absolute' style='width: 340px;top: 50%;left: 50%; transform: translate(-50%, -50%);filter: contrast(1.3)'>",attr: {org: "element",name: "element",element: "div",type: "company-container",untx: "UTF-8 unicode ascii"},data: {org: "element",skeletion: "active"},parent: js.$("#companies-container"), style: {height: "auto", marginTop: "40px", "--i": 2}}),        
        ...
        },
        {
            e: div({
                ...
                div({id: "company-container",class: ["company-container", "user-interface", "end-display-block", "end-position-relative"],text: "<img src='./public/images/project-3d-par-ishak.jpeg' class='end-position-absolute' style='width: 100%;height: 200px;object-fit:cover;object-position:center center;top: 50%;left: 50%; transform: translate(-50%, -50%);filter: blur(100px) contrast(2);border-radius: var(--html-border-radius-l)'><img src='./public/images/project-3d-par-ishak.jpeg' class='end-position-absolute' style='width: 100%;top: 50%;left: 50%; transform: translate(-50%, -50%);height: 200px;object-fit:cover;object-position:center center;filter: contrast(1.3);border-radius: var(--html-border-radius-l)'>",attr: {org: "element",name: "element",element: "div",type: "company-container",untx: "UTF-8 unicode ascii"},data: {org: "element",skeletion: "active"},parent: js.$("#companies-container"), style: {height: "200px", marginTop: "40px", "--i": 2}})
                ]))
        },
        {
            e: div({
